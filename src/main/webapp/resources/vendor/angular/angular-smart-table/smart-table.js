...
ng.module('smart-table', []).run(['$templateCache', function ($templateCache) {
    $templateCache.put('template/smart-table/pagination.html',
        '<nav data-ng-if="pages.length >= 2"><ul class="pagination">' +
        '<li data-ng-repeat="page in pages" ng-class="{active: page==currentPage}"><a data-ng-click="selectPage(page)">{{page}}</a></li>' +
        '</ul></nav>');
}]);
