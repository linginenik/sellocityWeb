 ...
 */
@Entity
@Table(name="SC_SALESPLAY_TESTIMONIALS", uniqueConstraints = @UniqueConstraint(columnNames = "TESTIMONIAL_ID"))
public class SalesPlayTestimonials implements Serializable{
	...
	/**
	 * @param testimonialId the testimonialId to set
	 */
